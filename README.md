...
- tests de integración server-side del handler `/api/contact` con `Request` nativo de Node y Resend completamente mockeado para transporte, esquema, honeypot, rate limit y errores;
