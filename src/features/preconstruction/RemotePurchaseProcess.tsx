...
type RemotePurchaseProcessProps = {
  copy: PreconstructionContent["remote"];
};

export function RemotePurchaseProcess({ copy }: RemotePurchaseProcessProps) {
  return (
    <section
      data-preconstruction-block="remote"
      aria-labelledby="preconstruction-remote-title"
      ...
      <div className="mx-auto max-w-6xl px-4 py-16 sm:py-24">
        <div className="grid gap-10 lg:grid-cols-[0.72fr_1.28fr] lg:items-center lg:gap-14">
          <div>
            ...
            <h2 id="preconstruction-remote-title" className={sectionTitleClass}>
              {copy.title}
            </h2>
          ...
          <div className="relative overflow-hidden rounded-2xl border border-[#0A2540]/10 bg-white p-6 shadow-[0_18px_55px_rgba(10,37,64,0.08)] sm:p-8">
            ...
            <div className="mx-auto flex max-w-md flex-col items-center text-center">
              ...
              <p className="mt-1 text-sm leading-5 text-[#0D1521]/62">{copy.centerCopy}</p>
              ...
              <ul className="relative grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
                {copy.roles.map((role, index) => {
                  ...
                  return (
                    <li
                      key={role}
                      className="relative flex min-h-24 flex-col items-center justify-center rounded-xl border border-[#0A2540]/10 bg-[#FBFAF7] px-3 py-4 text-center"
                    >
