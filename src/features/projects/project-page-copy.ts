...
export const projectPageCopy = {
  es: {
    ...
    ctas: {
      whatsapp: "Hablar con Esteban",
      whatsappLabel: (name: string) => `Hablar con Esteban por WhatsApp sobre ${name}`,
  ...
  en: {
    ...
    ctas: {
      whatsapp: "Talk to Esteban",
      whatsappLabel: (name: string) => `Talk to Esteban on WhatsApp about ${name}`,
