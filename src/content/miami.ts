...
const content = {
  es: {
    ...
    lifestyle: {
      ...
      points: [
        "Vida frente al agua",
        "Clima y actividades durante todo el año",
        "Gastronomía y cultura internacional",
        "Deportes y eventos",
        "Turismo y segunda residencia",
        "Atractivo para residentes y empresas",
      ],
  ...
  en: {
    ...
    lifestyle: {
      ...
      points: [
        "Waterfront living",
        "Year-round climate and activities",
        "International dining and culture",
        "Sports and events",
        "Tourism and second residences",
        "Appeal for residents and companies",
      ],
